                    ...
                    select: {
                                ...
                                if (util.f.isElem(child)) {
                                    if (child.classList.contains("deselect")) {
                                        ...
                                        if (!field.dataset.value) {
                                            util.f.addStyle(child, ["FontSize", "Top"], ["16px", "0px"]);
                                        }
                        ...
                        selection: function (child, parent) {
                            ...
                            if (util.f.isElem(child) && util.f.isElem(parent)) {
                                ...
                                $("#complaintValue").val(child.dataset.value);
                                console.log( $("#complaintValue").val());
                            ...
                            for (i = 0; i < children.length; i += 1) {
                                ...
                                if (util.f.isElem(child)) {
                                    if (child.classList.contains("psuedo_select")) {
                                        ...
                                        util.f.addStyle(child, ["FontSize", "Top"], ["12px", "-19px"]);
                                    }
                                }
                            }
                        },
...
background-color: #161616;  ; top: 10%; left:35%;  height: auto; width: 30% ">
    ...
    /* واحفظ السبب مع الايدي تبع القروب واليوزر نيم حق الي مرسل في الداتا بيس*/
    $_COOKIE["username"]; /* هذا اليوزر نيم  */
    ?>
    <div class="GroupNameDiv"><?php echo $groupname; ?></div>


    <form action="GfileComplaintPost.php" method="POST" >
        <input id="complaintValue" type="hidden" name="complaint" value="">

        <input type='hidden' name='idOfOpendGroup' value='<?php echo $groupid   ?>'>
        <label id="img_category_label"class="field"for="img_category"data-value="">
            ...
            <div id="img_category"class="psuedo_select"name="img_category">
                ...
                <ul id="img_category_options"class="options" >
                    <li class="option"data-value="الرابط لا يعمل">الرابط لا يعمل</li>
                    <li class="option"data-value="القروب ليس للمادة الموضوعة">القروب ليس للمادة الموضوعة</li>
                    <li class="option"data-value="القروب غير متفاعل">القروب غير متفاعل</li>
                    <li class="option"data-value="القروب غير ملائم للبيئة الجامعية">القروب غير ملائم للبيئة الجامعية</li>
