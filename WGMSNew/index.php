    ...
    <header>
        ...
        <ul>
            ...
            if (!isset($_COOKIE["username"])) {
                echo '<li><a class="ab" href="LogIn.php"> تـسجـيـل الدخول</a></li></ul>';
            }

            if (isset($_COOKIE["username"])) {
                echo '<li><a class="ab" href="Logout.php">تـسـجـيل الـخـروج</a></li>';
                echo '<li><a type="submit" class="ab" name="add" href="addGroup.php">اضـافـة قـروب</a></li></ul>';
    ...
    <table class="table table-striped" style="top:0px ; color: #ffffff">
        ...
        if (mysqli_num_rows($res_group_name) > 0) {
            ...
            while ($row = $res_group_name->fetch_assoc()  ) {
                ...
                echo '<td><a href="' . $row["courselink"] . '" class="aButton" style="pointer-events: all">انضمام</a></td></tr>';
