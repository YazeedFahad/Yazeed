...
background-color: #161616;  ; top: 10%; left:35%;  height: auto; width: 30% ">
    ...
    ?>
    <div class="GroupNameDiv"><?php echo $comment; ?></div>


    <form action="CfileComplaintPost.php" method="POST" >
        ...
        <label id="img_category_label"class="field"for="img_category"data-value="">
            ...
            <div id="img_category"class="psuedo_select"name="img_category">
                ...
                <ul id="img_category_options"class="options" >
                    <li class="option"data-value="تعليق غير مفيد">تعليق غير مفيد</li>
                    <li class="option"data-value="تعليق مكرر">تعليق مكرر</li>
                    <li class="option"data-value="تعليق بذئ">تعليق بذئ</li>
